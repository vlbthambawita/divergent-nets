...
from my_models.delphi_ensemble import DelphiEnsemble
...
def check_test_score(opt):
    ...
    checkpoint_dict = torch.load(opt.test_checkpoint)
...
def check_val_full_score(opt):
    ...
    opt.record_name = "VALIDATION"

    best_model = DelphiEnsemble(opt)
